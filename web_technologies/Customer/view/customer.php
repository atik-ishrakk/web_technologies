<?php 
session_start();
include_once "../control/customer_control.php";
...
if ($user && !empty($user['fname']) && !empty($user['lname']) && !empty($user['phone']) && 
    !empty($user['email']) && !empty($user['gender']) && !empty($user['address']) && 
...
<html>
<head>
    <title>Auto Drives (Customer Form)</title>
